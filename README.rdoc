...
=== Creating an instance of the MessageBus Stats client:

  var client = MessageBusFactory.CreateStatsClient("<Your API Key Here>");

=== Creating an instance of the MessageBus Mailing List client:
...
Status results for transmissions of messages to the MessageBus server are returned via the standard C# event model.
